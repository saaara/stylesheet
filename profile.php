		...
		<div class="container">
			<div class="row">
				<div class="col-md-8 col-xs-12">
	                ...
	                <form class="form-add form-group" required>

	                    <div class="group">
	                        <label><i class="fas fa-user"></i> الاسم الكامل</label>
	                        <input class="form-control" type="text" value="<?=USER_NAME?>" required>
	                    </div>
	        
	                    <!-- <div class="group">
	                        <label><i class="fas fa-map-marker-alt"></i> المدينة</label>
	                        <input class="form-control" type="text" value="الرياض" required>
	                    </div>
	        
	                    <div class="group">
	                        <label><i class="fas fa-map-marked-alt"></i> العنوان</label>
	                        <input class="form-control" type="text" value="الرياض شارع 25"  required>
	                    </div> -->
	        
	                    <div class="group">
	                        <label><i class="fas fa-phone"></i> الهاتف</label>
	                        <input class="form-control" type="tel" value="<?=USER_PHONE?>" required>
	                    </div>
