            ...
            <div class="x_panel">
                ...
                <div class="x_content">
                    <table id="datatable-fixed-header" class="table table-striped table-bordered">
                        ...
                        <?php
                        $usr = USER_ID;
                        $q = "SELECT * FROM `sales` WHERE (`status` <> 3 AND `uid` = '$usr')  ORDER BY `id` DESC";
                                ...
                                <div class="form-group col-md-12">
                                    <div class="col-md-6">
                                        ...
                                        <select name="step" class="form-control">
                                            <option value="0">مرحلة المراجعة</option>
                                            <option value="1">مرحلة  الموافقة والشحن</option>
                                            <option value="2">مرحلة   التوصيل للوجهة المطلوبة</option>
                                            <option value="3">مرحلة   استلام الشحنة من قبل المشتري  </option>
                                        </select>
                                    </div>
                                    </form>
                                    <div class="col-md-6">
