            ...
            <div class="x_panel">
                ...
                <div class="x_content"> 
                    ...
                    <div class="form-group">
                        <div class="col-md-12 row">
                            <button class="btn btn-primary" onclick="add_mark()">إضافة</button>
                        </div>
                    </div> 
                                        ...
                                        <div class="modal-body modal-body-sub_agile">
                                            <div class="modal_body_left modal_body_left1">
                                                <h3 id="dmsg<?=$showrc['id']?>">
                                                    هل أنت متأكد من أنك تريد  حذف هذه الماركة ؟
                                                </h3>
                                                <button class="btn btn-danger" onclick="del('marks','<?=$showrc[id]?>')">حذف</button>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- //Modal content-->
