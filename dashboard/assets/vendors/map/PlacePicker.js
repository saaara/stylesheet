...
$.fn.PlacePicker = function (t) {
    ...
    $(this).closest("div").hover(function(){
        ...
        var btn = $('<div class="placePickerUIButton" title="Pick location from map" style="position:absolute;top: 27px;left: 15px;z-index: 1000;"><div class="'+params.btnClass+'"><i class="fa fa-map"></i></div></div>');
        $(this).append(btn);
        btn.click(function(){
