            ...
            <div class="x_panel">
                ...
                <div class="x_content">
                    <table id="datatable-fixed-header" class="table table-striped table-bordered">
                        ...
                        {
                            $q = "SELECT DISTINCT * FROM `sales` ORDER BY `num`";
                        }
                        else
                        {
                            $uid = USER_ID;
                            $q   = "SELECT DISTINCT * FROM `sales` WHERE `uid` = '$uid' ORDER BY `num`";
                        }
                        ...
                        <tr>
                            ...
                            <th><?=$nums?></th>
                            <th>
                                <a href="all_receipts?pid=<?=$showp['receipt']?>" target="_blank" class="btn btn-warning btn-flat"><i class="fa fa-file"></i></a>
                            </th>
                        </tr>
                        <?}?>
                        </tbody>
