								...
								<div class="cart-block">
									...
									<div class="list">
										...
										while($show_cart = $get_cart->fetch_array())
										{
											...
											$item_total   = $show_product['newprice'] * $show_cart['q'];
											$total = $total + $item_total;
											$get_image = $engine->get_photos($show_product['pid']);
											$show_image = $get_image->fetch_array();
										?>
										<div class="cart-product">
											<button class="remove" onclick="addto_cart('<?=$show_product['pid']?>','del')"><i class="glyphicon glyphicon-trash"></i> </button>
											<div class="info">
												...
												<div class="info-block">
													...
													<span class="duration">
														...
														ينتهي: <?=counttime($show_product['edate'])?>
													</span>
													<span class="sall">
											...
											<div class="price">
												<span class="stander" value="<?=$show_product['newprice']?>">
													SAR <?=$show_product['newprice']?>
												</span>
												<div class="value-button decrease-btn" value="Decrease Value">-</div>
												<input type="number" value="<?=$show_cart['q']?>" min="0" disabled />
												<div class="value-button increase-btn" value="Increase Value">+</div>
												<span class="total">
													SAR <?=$show_product['newprice'] * $show_cart['q']?>
												</span>
											</div>
										</div>
										<?}?>
